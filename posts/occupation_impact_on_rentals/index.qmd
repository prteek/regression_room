...
This exercise is helpful with a test for the fact that new supply does not significantly change the underlying renting propensity (.pred). This would mean that under existing conditions, new supply can likely be absorbed by the market. <br/>
