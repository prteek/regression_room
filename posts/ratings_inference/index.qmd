...
abstract: |
  Likelihood-based inference is applied to estimate brand favorability from product ratings using a hierarchical beta-binomial model. This approach captures heterogeneous user preferences and provides principled estimates of rating propensity for brand comparison.
execute:
  echo: false
  warning: false
---
