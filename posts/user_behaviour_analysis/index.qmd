...
And from here, finally estimate states for each user_id, corresponding to each day in the data.
...
kable(states %>% filter(grepl('269b7f13-a509-5174-85cb', user_id)) %>% filter((date >= as.Date('2020-10-18')) & (date <= as.Date('2020-10-30'))))
