...
The aim of this post is to do a comparative analysis of mpg of various manufacturers using linear mixed effects models. The data is taken from the *mpg* dataset available in R [@ggplot2]. <br/>
