...
The idea is to study a particular configuration (Front wheel drive, compact/midsise/sub-compact petrol variants) of cars and assess how significant is the difference in *mpg* among manufacturers when controlling for other attributes like engine displacement, transmission type, number of cylinders, model and year. <br/>
