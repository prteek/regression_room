...
This makes intuitive sense, when Fisher information is high (clearly defined maximum and high curvature of *score*), then the uncertainty in parameter estimate should be low.
...
```
The maximum can be noticed at $p=0.4$ (equal to $n/y$ in both cases as derived earlier). For larger sample size $n=50$ the curvature is greater as there is more information in this case. <br/>
